...
def test_get_markets_for_tokens_v2(default_config: Config) -> None:
    ...
    usdc = client.chain_config.get_token_info(evm_client.to_checksum_address(usdc_address))
    weth = client.chain_config.get_token_info(evm_client.to_checksum_address(weth_address))
