...
def test_get_markets_for_tokens(eth_client: UniswapClientV3) -> None:
    ...
    usdc = eth_client.chain_config.get_token_info(evm_client.to_checksum_address(usdc_address))
    weth = eth_client.chain_config.get_token_info(evm_client.to_checksum_address(weth_address))
