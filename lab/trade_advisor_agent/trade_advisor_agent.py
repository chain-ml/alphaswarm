...
async def main() -> None:
    ...
    with open(BASE_PATH / "lab/research_agent_system_prompt.txt", "r") as f:
    ...
    agent = AlphaSwarmAgent(model_id="anthropic/claude-3-5-sonnet-20241022", tools=tools, system_prompt=system_prompt)
