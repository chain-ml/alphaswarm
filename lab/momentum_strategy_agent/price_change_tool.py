...
class TokenPriceChangeCalculator(Tool):
    ...
    def forward(self, token_address: str, frequency: str, n_samples: int, network: str = "eth-mainnet") -> dict:
        ...
        return {
            ...
            "network": network,
            "start_time": prices[0].timestamp.isoformat(),
            "end_time": prices[-1].timestamp.isoformat(),
